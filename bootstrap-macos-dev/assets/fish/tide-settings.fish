# Portable snapshot of the originating Tide prompt. Generated from universal
# tide_* variables only. Do not copy fish_variables between machines: it also
# contains generated caches and absolute home-directory paths.
